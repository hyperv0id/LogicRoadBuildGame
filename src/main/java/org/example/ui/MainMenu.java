...
public class MainMenu extends FXGLMenu {
    ...
    public MainMenu() {
        ...
        ImageButton btn2 = new ImageButton("images/x2(1)",69, 76, () -> {});
        ImageButton btn3 = new ImageButton("images/x3(1)",122, 73, () -> {});
        ImageButton btn4 = new ImageButton("images/x4(1)",85, 73, () -> {});
        ...
        Image tip1 = new Image("assets/textures/ui/images/newtip1.png",113,84,true,true);
        ImageView tip1View = new ImageView(tip1);
        tip1View.setVisible(false);
        Image tip2 = new Image("assets/textures/ui/images/newtip2.png",136,78,true,true);
        ImageView tip2View = new ImageView(tip2);
        tip2View.setVisible(false);
        Image tip3 = new Image("assets/textures/ui/images/newtip3.png",120,76,true,true);
        ImageView tip3View = new ImageView(tip3);
        tip3View.setVisible(false);
        Image tip4 = new Image("assets/textures/ui/images/newtip4.png",146,116,true,true);
        ...
        btnBox2.setOnMouseClicked(e -> {
            RoadBuilderApp.chosenLevel = 2;
            getController().startNewGame();
        });
        btnBox3.setOnMouseClicked(e -> {
            RoadBuilderApp.chosenLevel = 3;
            getController().startNewGame();
        });
        btnBox4.setOnMouseClicked(e -> {
            RoadBuilderApp.chosenLevel = 4;
            getController().startNewGame();
        });
